...
public class NotesPage extends BasePage {
    ...
    public NotesPage(AndroidDriver driver) {
        super(driver);
    }
    ...
    public void createNote(String title, String content) {
		...
		/*
		 * click(newNoteButton); enterText(noteTitleField, title);
		 * enterText(noteContentField, content); click(saveNoteButton);
		 */
    }

    public boolean isNoteVisible() {
        return isElementDisplayed(By.xpath("//android.widget.TextView[@text='" + "This is First Note1" + "']"));
    }
}
